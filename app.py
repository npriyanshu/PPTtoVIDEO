...
#     # Check if the slide has a shape with an image
#     image_found = False
#     for shape in slide.shapes:
#         if shape.shape_type == 13:  # 13 corresponds to an image shape
#             # Get the image data from the shape
#             image_stream = shape.image.blob
#             img_stream.write(image_stream)
#             img_stream.seek(0)
#             image_found = True
#             break  # Stop after finding the first image shape
